...
export const FilterValueEditor: React.FC<Props> = (props) => {
...
const SingleValueEditor: React.FC<SingleValueProps> = ({ column, valuePath, ...rest }) => {
...
const DoubleValueEditor: React.FC<Props> = ({ column, ...rest }) => {
  if (!column) return <span className='filter-editor-value'><span className='no-value'>&lt;Choose Column&gt;</span></span>;
...
const MultiValueEditor: React.FC<Props> = ({ column, filter, setState, ...rest }) => {
  if (!column) return <span className='filter-editor-value'><span className='no-value'>&lt;Choose Column&gt;</span></span>;
