...
export const OrderByList: React.FC<OrderByProps> = function OrderByList({ currentGroupBy, dragColumn, containerId, isDropDisabled, sortedColumns, visibleColumns, setVisibleColumns, isDragDisabled }) {
...
const ColumnEl: React.FC<ColumnProps> = function ColumnEl({ dragColumn, col, colIndex, isVisible, toggleVisibility, isDragDisabled, currentGroupBy }) {
