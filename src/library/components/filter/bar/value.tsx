...
export const QuickFilterValue: React.FC<Props> = function QuickFilterValue(props) {
...
const DoubleValue: React.FC<Props> = function DoubleValue(props) {
  return <>
    {'['}
...
const MultiValue: React.FC<Props> = function MultiValue(props) {
...
const SingleValue: React.FC<SingleValueProps> = function SingleValue({ column, filter, valuePath }) {
